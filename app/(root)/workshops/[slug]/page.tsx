...
const SingleWorkshopPage = async ({params}: { params: Params }) => {
    ...
    const finalPrice = calculatedPrice(workshop.price!, workshop.promotions[0])
                        ...
                        <CardContent className={"p-6"}>
                            <div className="flex items-center justify-between mb-6">
                                ...
                                <span className={"text-2xl font-bold text-primary"}>
                                    ...
                                    <ProductPrice finalPrice={finalPrice} price={workshop.price} size={"2xl"} />
                                </span>
                            </div>
                            ...
                            {isEnrolled ?
                                ...
                                workshop.price === 0 ?
                                    <p className={"text-xs text-muted-foreground mt-4 text-center"}>
                                        <EnrollmentButton workshopId={workshop.id} btnLabel={"Enroll Free Course"}/>
                                    </p>
                                    : <>
                                        <EnrollmentButton workshopId={workshop.id} btnLabel={"Enroll Now !"}/>
                                        <p className={"text-xs text-muted-foreground mt-4 text-center"}>
