...
export async function attachQuiz(values:AttachQuizFormToCourse): Promise<ApiResponseType> {
    ...
    try {
        ...
        await prisma.quiz.update({
            ...
            data: {
                courseId: values.chapterId ? null : values.courseId,
...
export async function detachQuizFromChapter( quizId:string, courseId:string, chapterId:string): Promise<ApiResponseType> {
    ...
    try {
        ...
        return {
            status: "success",
            message: "Quiz Detached from Chapter  successfully"
        }
    } catch {
        return {
            status: "error",
            message: "Fail to update detach a quiz from chapter"
        }
    }
}
