...
import {categorySchema, CategorySchema, featureSchema, FeatureSchema} from "@/lib/db/zodSchemas";
...
export async function createFeature(values: FeatureSchema): Promise<ApiResponseType> {
