...
import { updateLearningPathTags} from '../actions';
import {toast} from "sonner";

const UpdateTagsList = ({listTags, learningPathId, existingTags}:
                        { listTags: TagType[] | null, learningPathId: string, existingTags: TagType [] }) => {
    ...
    const handleUpdate = () => {
        startTransition(async () => {
            await updateLearningPathTags(learningPathId, selected)
            if (allTags !== null)
