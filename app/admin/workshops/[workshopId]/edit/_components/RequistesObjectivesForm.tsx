...
import {addObjectiveToWorkshop, addRequisiteToWorkshop} from "@/app/admin/workshops/[workshopId]/edit/actions";

const RequisitesObjectivesForm = ({workshopId, type}: {
    workshopId: string,
    ...
    const onSubmit = (values: ObjectiveRequisiteSchema) => {
        startTransition(async () => {
            if (type === 'Requisite') {
                await addRequisiteToWorkshop(workshopId, values)
            } else {
                await addObjectiveToWorkshop(workshopId, values)
            }
            form.reset({content: ""});
            setOpen(false)
