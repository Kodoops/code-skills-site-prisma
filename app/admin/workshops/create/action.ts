...
import {courseSchema, workshopSchema, WorkshopSchema} from "@/lib/db/zodSchemas";
...
export async function createWorkshop(values: WorkshopSchema): Promise<ApiResponseType> {
    ...
    try {
        ...
        await prisma.workshop.create({
            data: {
                ...
                statement : validation.data.status,
                user: {
