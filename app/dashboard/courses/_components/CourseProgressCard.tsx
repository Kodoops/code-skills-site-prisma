    ...
    return (
        <Card className={"group relative py-0 gap-0"}>
            ...
            <CardContent className={"p-4"}>
                <Link href={`/dashboard/courses/${data.course.slug}`} className={"text-lg font-medium line-clamp-2 hover:underline group-hover:text-primary transition-colors"}>
                    {data.course.title}
                </Link>
                ...
                <Link href={`/dashboard/courses/${data.course.slug}`} className={buttonVariants({className: "w-full mt-4"})}>Learn More</Link>
