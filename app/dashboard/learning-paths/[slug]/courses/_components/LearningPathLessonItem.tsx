...
export function LearningPathLessonItem({lesson, slug, isActive, completed}: LessonItemProps) {
...
export function LearningPathLessonLinkItem({lesson, slug,learningPathSlug, isActive, completed}: LessonItemProps) {
    ...
    return(
        <Link className={buttonVariants({
            ...
            className: cn(
              ...
              href={`/dashboard/learning-paths/${learningPathSlug}/courses/${slug}/${lesson.id}`}
        >
            <div className="flex items-center gap-2.5 w-full min-w-0">
                <div className="shrink-0">
                    {
