...
-- CreateEnum
CREATE TYPE "public"."InvoiceItemType" AS ENUM ('COURSE', 'WORKSHOP', 'SUBSCRIPTION', 'LEARNING_PATH');
...
CREATE TABLE "public"."Workshop" (
    ...
    "fileKey" TEXT NOT NULL,
    "statementsStartFileKey" TEXT,
    "statementsStartFileUrl" TEXT,
    "statementVideoKey" TEXT,
    "price" INTEGER NOT NULL,
    "currency" TEXT NOT NULL DEFAULT 'EUR',
    "duration" INTEGER NOT NULL,
    "status" TEXT NOT NULL,
...
-- CreateIndex
CREATE UNIQUE INDEX "uq_enrollment_user_course" ON "public"."Enrollment"("userId", "courseId");
...
-- AddForeignKey
ALTER TABLE "public"."LearningPathItem" ADD CONSTRAINT "LearningPathItem_learningPathId_fkey" FOREIGN KEY ("learningPathId") REFERENCES "public"."LearningPath"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "public"."Enrollment" ADD CONSTRAINT "Enrollment_learningPathId_fkey" FOREIGN KEY ("learningPathId") REFERENCES "public"."LearningPath"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."Enrollment" ADD CONSTRAINT "Enrollment_workshopId_fkey" FOREIGN KEY ("workshopId") REFERENCES "public"."Workshop"("id") ON DELETE CASCADE ON UPDATE CASCADE;
